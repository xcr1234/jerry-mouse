 ...
 * involves one of the provided cacheExtensions of
 * {@link com.jerry.mouse.util.upload.FileUpload FileUpload} such as
 ...
 * {@link com.jerry.mouse.util.upload.FileItem FileItem} instances,
 * such as
 * {@link com.jerry.mouse.util.upload.disk.DiskFileItemFactory DiskFileItemFactory}.
 * </p>
 * <p>
 ...
 *
 *   ServletFileUpload com.jerry.mouse.util.upload = new ServletFileUpload(factory);
 *   // maximum size before a FileUploadException will be thrown
 *   com.jerry.mouse.util.upload.setSizeMax(1000000);
 *
 *   List fileItems = com.jerry.mouse.util.upload.parseRequest(req);
